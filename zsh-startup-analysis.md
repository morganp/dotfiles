...
> These measurements describe the configuration before Oh My Zsh and Spaceship
> were installed. The final Spaceship setup measured 175.74 ms median over 60
> warm launches. Portable configuration now lives in the tracked
> `config/shell/dot-zprofile`; local `.zprofile` sources it and retains internal
> Codex configuration.
